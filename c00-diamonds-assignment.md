...
- As the carats get bigger they become more expensive, however as the
  carats get bigger the prices also start to vary more. There is also
  very defined lines every 0.5 addition to a carat.
...
diamonds %>% 
  ...
  ggplot() +
  geom_point(aes(x = carat, y = price, color = n))
```
...
- The cuts are more spread out then I thought they would be. I didn’t
  ...
  diamonds. It seems like while the cut may have some role in pricing,
  the more important thing is the carat. Additionally the diamonds are
  much more concentrated on the lower price range and become a lot more
  rare the bigger the carat and the higher the price, which makes sense.

...
-   As the carats get bigger they become more expensive, however as the carats get bigger the prices also start to vary more. The data also tends to trend to having defined lines every 0.5 addition to a carat.
...
-   The cuts are more spread out then I thought they would be. I didn't expect fair cuts to be on the more expensive and higher carat diamonds. It seems like the cut doesn't have a strong effect on the pricing, the more important thing is the carat. Additionally the range of pricing for diamonds expands rapidly for diamonds higher then around 1 carat.
...
![![](images/clipboard-1486334410.png)Terminal](./images/c00-unstaged.png)

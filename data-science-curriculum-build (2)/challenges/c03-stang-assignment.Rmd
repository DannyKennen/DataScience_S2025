...
-   Is there "one true value" for the material properties of Aluminum?
    ...
    -   No, there are various values of thickness and rolling angles in this dataset, and external to this dataset there are various alloys of aluminum to account for as well.

-   How many aluminum alloys are in this dataset? How do you know?

    -   There is one alloy, al_24st. This is the only alloy named, and the scientists testing the aluminum for this dataset were not testing for different alloys so it makes sense to have it as a control.
...
-   Does the thickness of the aluminum have more control over how much the sheet will deform then the angle?
...
-   In general the thickness of the sheet will maintain a Poisson's ration withing a certain range, however the angle of the rolling direction will effect the poisson's ratio within the thicknesses. There is specifically a pretty big jump at 45 degrees for the 0.022 thickness. I would say that as a whole it appears that the thickness controls where the deformation will fall, but the angle does have a non negligible amount of control of the exact nu value.
...
-   Does this graph support or contradict the claim above?
    -   There are similar trends for both graphs, the thickness tends to group near a range of nu values, but there are still outliers like in the previous graph.
-   Is this evidence *conclusive* one way or another?
    -   I would need to do more analysis about how much variety is in each thickness group to see what is the more controlling factor.
